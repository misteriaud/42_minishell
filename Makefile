...
FILES					:=	main.c \
							...
							run_process.c run_process2.c redirect_in.c redirect_out.c exit_status.c \
							...
							init_built_in.c search_built_in.c echo.c cd.c pwd.c unset.c export.c exit.c env.c writer.c \
							status.c
